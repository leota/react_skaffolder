...
// Database
import Database_React_skaffolder_db from "./Database_React_skaffolder_db.js";

// Controllers
import UserController from "../controllers/React_skaffolder_db/UserController";
...
class Server {
  ...
  async init() {
    ...
    // Start Init Database
		Database_React_skaffolder_db.init();
 // End Init Database
